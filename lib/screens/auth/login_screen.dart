...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _onAuthChanged() {
    ...
    if (_controller.status == AuthStatus.success) {
      Navigator.pop(
        context,
      ); // fecha o login, o MainShell por baixo reage sozinho
    }
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Stack(
                children: [
                  // Login não é mais obrigatório (visitante navega sem
                  // conta) — essa tela agora é sempre empurrada por
                  // cima de outra (push), então dá pra voltar com um
                  // simples pop, sem precisar saber pra onde volta.
                  Align(
